...
levels(CE) <- c("darkorange", "cornflowerblue", "darkolivegreen3", "deeppink3", "darkorchid", "brown1", "darkgrey", "chartreuse", "#F8766D", "#00BFC4" , "black", "pink") 
CE <- as.character(CE) 

plotMDS(dgeFilExpNorm, col = CE, labels = NULL, pch = 20)
