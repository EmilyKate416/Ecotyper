...
ecotype_abundances <- read_delim("Output/Data/20230921_EcoTyperResults_TatlowPiccoloTPMmedian/Carcinoma_Ecotypes/Ecotype_Assignment.txt ", delim = "\t") %>% 
...
#write_csv(results_HRDhigh, "I:/research/jblab/data/group_folders/emily_lythgoe/20230724_EcoTyper_2nd_year/Output/Data/20230922_topTableDE_BRCA12loss_vs_HRDhigh.csv")

results_HRDlow <- topTable(fittedContrasts, coef= "groupHRD_low - groupBRCA1_2_loss", sort.by = "P", n = Inf)
head(results_HRDlow, 20)
#write_csv(results_HRDlow, "I:/research/jblab/data/group_folders/emily_lythgoe/20230724_EcoTyper_2nd_year/Output/Data/20230922_topTableDE_BRCA12loss_vs_HRDlow.csv")
```
...
-adj.P.Val: p-value adjusted for multiple testing. Different adjustment method = Benjamini-Horchberg
...
text(x[o[1:10]], y[o[1:10]],labels = G[o[1:10]], # to show the top 10 DE gene symbols
...
**Gene ontology analsis with Goana**
