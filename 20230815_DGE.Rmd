...
volcanoplot(
  ...
  names = annotated_genes$gene_name,        # The gene symbols (replace 'genes$SYMBOL' with the actual gene symbol data)
...
logFC_contrast_low <- fittedContrasts$coefficients[, "groupHRD_low - groupBRCA1_2_loss"]
EnhancedVolcano::EnhancedVolcano(
  fittedContrasts,
  x = logFC_contrast_low,  # fittedContrasts$coefficients
  y = "logP",           # Specify the negative log10-transformed p-values
  title = "Volcano Plot",
  lab = annotated_genes$gene_name
)
```
