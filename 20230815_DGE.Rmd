...
sigGenes_HRDlow <- allDEgenes_BRCAloss_HRDlow %>% 
 ...
 browseKEGG(keggRes, 'hsa04657') # to visualise one of the hits in browser
 
``` 

```{r}
setwd("/mnt/jblab/group_folders/emily_lythgoe/20230724_EcoTyper_2nd_year/Output/Plots")
...
pathview(gene.data = logFC_HRDlow, 
         pathway.id = "hsa04657", 
         species = "hsa", 
         kegg.native = FALSE,  # Use the native KEGG colors for compounds
         multi.state = TRUE,
