...
Clone a repo:
Go to the shell, notice what directory you’re in. pwd displays the working directory. cd is the command to change directory. Make a folder called RFolder in C: (outside of user as everything in user will sink with onedrive)
