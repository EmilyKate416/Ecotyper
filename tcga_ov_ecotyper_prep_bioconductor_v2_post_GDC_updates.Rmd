...
DT::datatable(getResults(query, rows = 1:100), 
    filter = 'top',
...
#or experimenting how to combine the files from a manifest download into matrix
GDCRNATools::gdcRNADownload(project.id = "TCGA-OV", data.type="RNAseq")
metaMatrix <- GDCRNATools::gdcParseMetadata(project.id='TCGA-OV',
data.type='RNAseq')

rnaExpr <- GDCRNATools::gdcRNAMerge(metadata=metaMatrix, path='RNAseq/', data.type='RNAseq')
