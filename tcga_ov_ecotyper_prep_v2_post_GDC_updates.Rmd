...
gdcRNADownload(project.id = "TCGA-OV", data.type="RNAseq")
metaMatrix <- gdcParseMetadata(project.id='TCGA-OV',
data.type='RNAseq')

rnaExpr <- gdcRNAMerge(metadata=metaMatrix, path='RNAseq/', data.type='RNAseq')
